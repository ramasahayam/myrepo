package com.amortization;// Build an amortization schedule program using Java.
//
...
public class AmortizationSchedule {
    ...
    private AmortizationVO amortizationVO;

    public AmortizationSchedule(AmortizationVO amortizationVO) {
        this.amortizationVO  = amortizationVO;

    }

    /**
     *  generateAmortizationSchedule:: calls calculateAmortizationScheduleDetail which process the data and output.
     */
    public void generateAmortizationSchedule(){
        AmortizationCalculator calculator = new AmortizationCalculator();
        calculator.calculateAmortizationScheduleDetail(amortizationVO);
    }
